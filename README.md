...
## Project Structure
    ...
    ├── netmiko_scripts/
    │   └── scripts/
    │       ├── push_config.py      # Mass SSH push with threading
    │       ├── backup.py           # Automated backup + Git commit
    │       └── validate.py         # Basic validation
    ├── ansible/
    │   ├── inventory/
    ...
    ├── templates/
    │   ├── ospf.j2                 # OSPF Jinja2 template
    │   ├── vlan.j2                 # VLAN Jinja2 template
    │   └── acl.j2                  # ACL Jinja2 template
    ├── napalm/
    │   └── validator.py            # Post-deploy validation
    ├── dashboard/
    │   └── status.py               # Rich terminal dashboard
